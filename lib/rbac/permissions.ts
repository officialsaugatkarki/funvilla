...
export const PERMISSIONS = {
  ...
  // Swimming
  SWIMMING_ACCESS:          'swimming:access',
  SWIMMING_TICKETS:         'swimming:tickets',
  // Inventory
...
export const ROLE_PERMISSIONS: Record<RoleName, Permission[]> = {
  ...
  manager: [
    ...
    PERMISSIONS.POOL_ACCESS, PERMISSIONS.POOL_TICKETS, PERMISSIONS.SWIMMING_ACCESS, PERMISSIONS.SWIMMING_TICKETS,
...
export const ROUTE_PERMISSIONS: Record<string, Permission> = {
  ...
  '/admin/swimming':    PERMISSIONS.SWIMMING_ACCESS,
